...
router.route('/show/:id')
    .put(passportJWT, confirmUser(schemas.confirmedSchema), PropertyForController.show); 

// All properties for
router.route('/all')
    .put(passportJWT, confirmUser(schemas.confirmedSchema), PropertyForController.all); 
